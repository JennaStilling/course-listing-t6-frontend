<template>
  ...
  .desktop-course .hello-name-here {
	color: #000000;
  ...
  .desktop-course .overlap-group-2 {
	background-color: var(--white);
	border: 1px solid;
